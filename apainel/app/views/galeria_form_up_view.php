...
<div class="modal-dialog modal-lg">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title" id="myModalLabel">Alterar Galeria.</h4>
    </div>
    <div class="modal-body">
    <?php //var_dump($row);die;?>
	  <?php echo form_open_multipart('galeria/up/'.$row->idgaleria,'class="form-horizontal form-ajax-validate" role="form" id="form-gal"');?>
        
        <div class="form-group">
          <label class="col-xs-3 control-label"><span>Nome do Galeria:</span></label>
          <div class="col-lg-5">
            <input type="text" name="nomeGal" class="form-control input-compare" id="nomeGal" value="<?php echo $row->nomeGal;?>" validation="validate[required]" data-table="galeria" data-val="<?php echo $row->nomeGal;?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-2 col-md-2 col-sm-2">
            <img src="<?php echo img_size('uploads',$row->nomeImg,100,NULL,'apainel/');?>" class="img-thumbnail" id="img-view-gal" title="">
        ...
        <input type="hidden" name="idgaleria" value="<?php echo $row->idgaleria;?>">
        <!-- hidden -->

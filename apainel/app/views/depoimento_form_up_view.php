...
<div class="modal-dialog modal-lg">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title" id="myModalLabel">Alterar Depoimento.</h4>
    </div>
    <div class="modal-body">
    <?php //var_dump($row);die;?>
	  <?php echo form_open_multipart('depoimento/up/'.$row->iddepoimento,'class="form-horizontal form-ajax-validate" role="form" id="form-dep"');?>
        
        <div class="form-group">
          <label class="col-xs-3 control-label"><span>Nome do Depoimento:</span></label>
          <div class="col-lg-5">
            <input type="text" name="nomeDep" class="form-control input-compare" id="nomeDep" value="<?php echo $row->nomeDep;?>" validation="validate[required]" data-table="depoimento" data-val="<?php echo $row->nomeDep;?>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-2 col-md-2 col-sm-2">
            <img src="<?php echo img_size('uploads',$row->nomeImg,100,NULL,'apainel/');?>" class="img-thumbnail" id="img-view-dep" title="">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-5">
            <textarea type="text" name="depoimento" class="form-control" rows="7" validation="validate[required]"><?php echo $row->depoimento;?></textarea>
          </div>
        </div>
        ...
        <input type="hidden" name="iddepoimento" value="<?php echo $row->iddepoimento;?>">
        <!-- hidden -->
